...
import { BinanceSpotAdapter } from "./adapters/binance.js";
import { KucoinSpotAdapter }  from "./adapters/kucoin.js";
import { BybitSpotAdapter }   from "./adapters/bybit.js";
import { BitgetSpotAdapter }  from "./adapters/bitget.js";
...
const kucoin  = new KucoinSpotAdapter();
const bybit   = new BybitSpotAdapter();
const bitget  = new BitgetSpotAdapter();
